...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        resultLabel.frame = CGRect(x: 10, y: 30, width: screenWidth - (10 * 2), height: 170)
        ...
        resultLabel.font = UIFont(name: "LettersLaughingAtTheirExecution-WJLG", size: 50)
        ...
        for y in 0 ..< yButtonCount {
            for x in 0 ..< xButtonCount {
                ...
                let arrayColors :NSArray = [self.colorWithRGBHex(hex: 0xFFFFFF, alpha: 1.0).cgColor as Any,
                                            self.colorWithRGBHex(hex: 0xCCCCCC, alpha: 1.0).cgColor as Any]
