...
class ViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        if highScore1 != 0 {highScore1Label.text = String(format: "%.3f 秒", highScore1)}
        if highScore2 != 0 {highScore2Label.text = String(format: "%.3f 秒", highScore2)}
        if highScore3 != 0 {highScore3Label.text = String(format: "%.3f 秒", highScore3)}
    }
